# Contributing to myapi.rest — QR Code API

Thanks for your interest in improving the **QR Code API** documentation and examples!

This repository contains **docs, examples, and Postman collections** for the
myapi.rest QR Code API service. The core production API runs on myapi.rest
